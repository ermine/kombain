...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8eed1e194cf07bd0d2b68d2e6964e5c2) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "kombain_init.ml"; });
               Executable
                 ({
                     cs_name = "kombain";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "kombain.ml"; });
               Library
                 ({
                     cs_name = "kmb";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "markdown";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "kmb"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "markdown_test.ml"; });
               Executable
                 ({
                     cs_name = "md2html";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = "markdown";
                      bs_compiled_object = Byte;
                      bs_build_depends = [FindlibPackage ("tyxml", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "md2html.ml"; });
               Executable
                 ({
                     cs_name = "textile_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "textile_test.ml"; });
               Library
                 ({
                     cs_name = "bbcode";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      lib_modules = ["Bbcode_parser"; "Bbcode2html_converter"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "kmb";
                      lib_findlib_name = Some "bbcode";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bbcode_test.ml"; });
               Executable
                 ({
                     cs_name = "bbcode2html";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = "bbcode";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "bbcode"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "bbcode2html.ml"; });
               Executable
                 ({
                     cs_name = "abnf2peg";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "abnf2peg.ml"; });
               Executable
                 ({
                     cs_name = "xmlebnfreader";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "xmlebnfreader.ml"; });
               Executable
                 ({
                     cs_name = "xmltest";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "xmltest.ml"; });
               Executable
                 ({
                     cs_name = "yamlspecreader";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "yamlspecreader.ml"; 
                   });
               Executable
                 ({
                     cs_name = "yaml_test";
                   ...
                   {exec_custom = false; exec_main_is = "yaml_test.ml"; });
               Executable
                 ({
                     cs_name = "es_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "es_test.ml"; })
            ];
          plugins =
            [
     ...
     oasis_digest = Some "OÔBm¥^C€\029¤¿<³\019\022=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
